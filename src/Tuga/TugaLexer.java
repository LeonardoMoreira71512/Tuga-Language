...
public class TugaLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"ESCREVE", "RETORNA", "VERDADEIRO", "FALSO", "TypeINT", "TypeDOUBLE", 
			"TypeSTRING", "TypeBOOL", "INICIO", "FIM", "ENQUANTO", "SE", "SENAO", 
			"FUNCAO", "LPAREN", "RPAREN", "MINUS", "ADD", "MULT", "DIV", "MOD", "GT", 
			"LT", "GET", "LET", "IGUAL", "DIFERENTE", "NAO", "E", "OU", "VAR_NAME", 
			"WS", "SL_COMMENT", "ML_COMMENT", "DIGIT", "LETTER"
		};
	}
